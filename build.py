...
PAGES = [
    dict(
        lang="pl",
        md_file="Red Team na macOS - kompendium.md",
        out_file="index.html",
        title="Red Team na macOS — kompendium wiedzy ofensywnej i detekcyjnej",
        description="Kompletna ścieżka operacji red team w środowiskach macOS: rekonesans, eskalacja uprawnień, persistence, obejścia zabezpieczeń, C2, detekcja.",
        badge="Kompendium &middot; sierpień 2026",
        hero_title="Red Team na macOS",
        hero_sub="Kompletna ścieżka operacji ofensywnej w macOS: metodologia, techniki, narzędzia, infrastruktura C2 i kontrapunkt detekcyjny — zmapowane na MITRE ATT&amp;CK.",
        ...
        footer="Red Team na macOS — kompendium wiedzy ofensywnej i detekcyjnej &middot; stan na sierpień 2026",
        lang_switch_href="index-en.html",
        lang_switch_label="EN",
    ),
    dict(
        lang="en",
        md_file="Red Team on macOS - compendium.md",
        out_file="index-en.html",
        title="Red Team on macOS — an offensive and detection knowledge compendium",
        description="The complete red team operation path in macOS environments: reconnaissance, privilege escalation, persistence, security bypasses, C2, detection.",
        badge="Compendium &middot; August 2026",
        hero_title="Red Team on macOS",
        hero_sub="The complete offensive operation path on macOS: methodology, techniques, tools, C2 infrastructure, and the detection counterpoint — mapped to MITRE ATT&amp;CK.",
        ...
        footer="Red Team on macOS — an offensive and detection knowledge compendium &middot; as of August 2026",
